...
func (c *accessV1Client) GetName(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*GetNameResponse, error) {
...
func (UnimplementedAccessV1Server) GetName(context.Context, *empty.Empty) (*GetNameResponse, error) {
...
func _AccessV1_GetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccessV1Server).GetName(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
